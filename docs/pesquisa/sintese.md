...
> Espelho enxuto — **fonte de verdade:** [sintese-final.md](https://github.com/petzada/marctco/blob/main/sintese-final.md)  
> Decisões: [decisoes.md](https://github.com/petzada/marctco/blob/main/docs/pesquisa/decisoes.md) · Pluga: [pluga.md](https://github.com/petzada/marctco/blob/main/docs/pesquisa/pluga.md) · Manual: [sintese-manual.md](./sintese-manual.md)  
...
| Stack | Travada — [stack-recomendada.md](https://github.com/petzada/marctco/blob/main/stack-recomendada.md) |
...
- Detalhe das regras: [decisoes.md](https://github.com/petzada/marctco/blob/main/docs/pesquisa/decisoes.md).
...
- **Pluga:** ver [pluga.md](https://github.com/petzada/marctco/blob/main/docs/pesquisa/pluga.md) — tela = URL, secret, teste, logs, sync.  
...
- **Sem** inbox UI no MVP.  
- **Sem** ligação nativa (atendente usa app/telefone). VoIP = depois; riscos em [decisoes.md](https://github.com/petzada/marctco/blob/main/docs/pesquisa/decisoes.md).
...
Organização: um workspace = grupo/empresa mãe; filiais/times = tags — [ADR-0002](https://github.com/petzada/marctco/blob/main/docs/adr/0002-workspace-tags-times.md).
...
Escopo de pesquisa/síntese: **fechado**. Stack: **travada** ([stack-recomendada.md](https://github.com/petzada/marctco/blob/main/stack-recomendada.md)).  
**Guia único:** [sintese-final.md](https://github.com/petzada/marctco/blob/main/sintese-final.md)

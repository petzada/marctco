> **Documento de entrada (análise arquitetural).** Decisões consolidadas em [sintese-final.md](https://github.com/petzada/marctco/blob/main/sintese-final.md).

> **Supersessão:** deduplicação por telefone, payload livre e publicação direta em fila são apenas hipóteses históricas. Valem hoje: múltiplos contatos e revisão manual, `IntegrationEvent` como outbox ([ADR-0007](https://github.com/petzada/marctco/blob/main/docs/adr/0007-ingestao-idempotencia.md)) e contrato canônico `v1` com LP servidor-servidor ([ADR-0008](https://github.com/petzada/marctco/blob/main/docs/adr/0008-fronteira-conector-dominio.md)).
...
> **Atualização 2026-08-04:** decisões de stack **travadas**. Fonte de verdade: [stack-recomendada.md](https://github.com/petzada/marctco/blob/main/stack-recomendada.md) · [ADR-0001](https://github.com/petzada/marctco/blob/main/docs/adr/0001-stack-monolito-modular-ts.md). Organização do cliente (1 workspace/grupo + tags): [ADR-0002](https://github.com/petzada/marctco/blob/main/docs/adr/0002-workspace-tags-times.md).

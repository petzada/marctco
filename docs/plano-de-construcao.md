...
| A5 | **Fechado pela spec da Fase 4 e materializado pelo ticket 00:** WhatsMiau é tratado como gateway não-oficial; permanecem default `ON_ASSIGNMENT`, opt-in explícito, delay e rate limit. Se o contrato oficial do provedor mudar, a porta de mensageria permite revisitar a premissa sem trocar o domínio — [.scratch/canal/spec.md](../.scratch/canal/spec.md) · [ADR-0003](./adr/0003-whatsapp-instancia-unica-gatilho-atribuicao.md) | Fechado |

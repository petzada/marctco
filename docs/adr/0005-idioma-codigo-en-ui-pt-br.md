...
| Origem inbound do canal | `JobOrigin` variante `{ type: "channel_inbound"; integration_connection_id }` | Webhook autenticado pelo hash já existente. Não nasce função privada só para autenticar |

...
- Mitigações de ban obrigatórias no worker: opt-in explícito persistido, delay antes do envio e rate limit na fila. Variação automática de texto fica pós-MVP ([.scratch/canal/spec.md](../../.scratch/canal/spec.md)).

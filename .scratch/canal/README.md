...
Fase 4 de [docs/plano-de-construcao.md](https://github.com/petzada/marctco/blob/main/docs/plano-de-construcao.md). Estado de partida: Fases 0–3 entregues — [PROMPT-HANDOFF da Fase 3](../tempo/PROMPT-HANDOFF.md).

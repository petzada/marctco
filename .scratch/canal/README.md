...
Status da fatia: **especificada; tickets 00, 01, 02, 03a e 03b fechados.** Spec em [spec.md](./spec.md), tickets em [issues/](./issues/). Próximo: [03c](./issues/03c-disparo-na-atribuicao.md) (disparo na atribuição) em paralelo com [04](./issues/04-gatilho-na-chegada-e-quarentena.md) e [05](./issues/05-webhook-de-entrada.md).

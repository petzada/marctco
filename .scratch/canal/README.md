...
Status da fatia: **especificada; tickets 00, 01, 02 e 03a fechados.** Spec em [spec.md](./spec.md), tickets em [issues/](./issues/). Próximo: [03b](./issues/03b-dispatcher-worker-e-adapter.md) (dispatcher/HTTP) em paralelo com [03c](./issues/03c-disparo-na-atribuicao.md), [04](./issues/04-gatilho-na-chegada-e-quarentena.md) e [05](./issues/05-webhook-de-entrada.md).

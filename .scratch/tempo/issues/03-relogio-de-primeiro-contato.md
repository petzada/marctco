...
- [x] `Opportunity.first_contact_at` existe, anulável (expand/contract do [ADR-0010](https://github.com/petzada/marctco/blob/main/docs/adr/0010-migrations-e-ci-cd.md))
...
- [x] `markersFor` passa a receber o estado de SLA e a devolver o estourado como mais um marcador, respeitando "um lead, um ícone" do [ADR-0018](https://github.com/petzada/marctco/blob/main/docs/adr/0018-marcador-como-modulo.md)

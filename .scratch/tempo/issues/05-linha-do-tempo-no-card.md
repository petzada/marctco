...
- [ ] Operação nomeada que lista a linha do tempo de um lead recebendo `UserContext`, no escopo de perfil que a Fase 2 já aplica
- [ ] O card mostra os fatos em ordem, com o responsável anterior legível **pelo nome** dentro do fato de reatribuição, e não como identificador opaco
- [ ] Os fatos de ingestão que já existiam continuam aparecendo, sem virar model genérico das fases futuras
- [ ] Os fatos são imutáveis: nenhuma tela os edita
- [ ] A mesclagem transfere os fatos para a Oportunidade canônica, e nenhuma leitura segue a lápide
- [ ] Paginação ou teto de leitura: um lead com anos de histórico não carrega a linha do tempo inteira num render
- [ ] Segue o `DESIGN.md`; nenhum texto de tela desce para o domínio

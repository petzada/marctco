...
- [x] Clicar leva ao lead sob `/workspace/:slug/...` — o link nasce com o tenant dentro ([ADR-0012](https://github.com/petzada/marctco/blob/main/docs/adr/0012-contexto-de-tenant-na-url.md))

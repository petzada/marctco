...
- **A regra de idioma** ([ADR-0005](../../docs/adr/0005-idioma-codigo-en-ui-pt-br.md)): identificadores, commits e comentários de código em **inglês**; UI em **PT-BR**. Nenhum acento em identificador, arquivo ou branch.

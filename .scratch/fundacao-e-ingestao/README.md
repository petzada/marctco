...
Fatia vertical cobrindo as **Fases 0 e 1** de [docs/plano-de-construcao.md](https://github.com/petzada/marctco/blob/main/docs/plano-de-construcao.md). **Entregue.** Não começar por [PROMPT-INICIAL.md](../../PROMPT-INICIAL.md) — é histórico.

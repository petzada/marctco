...
- [x] O `arrived_at` do lead liberado é o instante da **liberação**; a quarentena é o único lugar do sistema onde algo fica retido, e um relógio que nasce estourado não tem como ser zerado ([ADR-0007](../../../docs/adr/0007-ingestao-idempotencia.md))

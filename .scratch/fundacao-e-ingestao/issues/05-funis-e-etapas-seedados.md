...
Nesta fatia os funis são **semeados, não editáveis pela interface** — mas o schema precisa suportar edição desde já, conforme o [ADR-0009](https://github.com/petzada/marctco/blob/main/docs/adr/0009-etapas-editaveis-papeis-e-status.md). A separação que faz isso funcionar: **rótulo e ordem pertencem ao cliente; papel pertence ao sistema.** Sem essa separação, renomear uma etapa quebraria a ingestão.

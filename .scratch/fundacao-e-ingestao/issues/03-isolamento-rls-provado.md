...
- [x] Schema `private` existe, com `EXECUTE` das funções revogado de todo papel exceto o do app, e `search_path` fixado em cada função
  ...
  — **Supersessão 2026-08-19:** a sexta nasceu no [ADR-0019](../../../docs/adr/0019-resolucao-pre-contexto-e-executor-privado.md) como `claim_overdue_opportunity_workspaces`; o Seam 3 passa a esperar seis quando o ticket 09 da Fase 3 a materializar, e continua reprovando a sétima.

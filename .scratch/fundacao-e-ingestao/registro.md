...
- **A lista fechada virou cinco.** `private.claim_expired_payload_workspaces`
  ...
  **Supersessão 2026-08-19:** o [ADR-0019](https://github.com/petzada/marctco/blob/main/docs/adr/0019-resolucao-pre-contexto-e-executor-privado.md)
  fecha a lista em seis; o [ADR-0016](https://github.com/petzada/marctco/blob/main/docs/adr/0016-contexto-de-acesso-e-leitor-escopado.md)

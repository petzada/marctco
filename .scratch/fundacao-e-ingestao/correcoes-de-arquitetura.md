...
> **Emendado pelo [ADR-0019](https://github.com/petzada/marctco/blob/main/docs/adr/0019-resolucao-pre-contexto-e-executor-privado.md):** a exceção sem contexto agora inclui a validação navegador → associação/workspace, totalizando quatro funções, e sua execução sob `FORCE RLS` usa papel técnico `NOLOGIN` com grants/policies mínimos.
...
> foram lidos dos ADRs 0004–0015, do [CONTEXT.md](https://github.com/petzada/marctco/blob/main/CONTEXT.md) e das 17 issues desta fatia.
...
|---|---|---|
| 3 · helper recebe o papel e não o exige · 4 · workspace, papel e flags viajam separados | Contexto de acesso e leitor escopado | [0016](https://github.com/petzada/marctco/blob/main/docs/adr/0016-contexto-de-acesso-e-leitor-escopado.md) |
| 1 · o módulo de ingestão não existe · 2 · a regra de identidade vaza pelo seam | Ingestão é decisão pura; o plano de escrita é dado | [0017](https://github.com/petzada/marctco/blob/main/docs/adr/0017-ingestao-como-decisao-e-plano.md) |
| 5 · "um lead, um ícone" sem módulo | Marcador é módulo de domínio | [0018](https://github.com/petzada/marctco/blob/main/docs/adr/0018-marcador-como-modulo.md) |
...
3. **As quatro consultas sem tenant são exceção declarada.** `resolve_workspace_by_token_hash`,
   ...
   Seam 3 reprova qualquer `SECURITY DEFINER` fora dela ([ADR-0006](https://github.com/petzada/marctco/blob/main/docs/adr/0006-rls-duas-camadas-guc-worker.md) regra 9).
...
é do [ADR-0019](https://github.com/petzada/marctco/blob/main/docs/adr/0019-resolucao-pre-contexto-e-executor-privado.md).

...
O efeito é o modo de falha que o [ADR-0015](../../docs/adr/0015-perfis-de-acesso-e-escopo.md) chama de vazamento interno silencioso: nada erra, nenhuma exceção sobe, o escopo só é maior do que a regra promete. A história 34 da [spec](https://github.com/petzada/marctco/blob/docs/arquivo-fases-0-4/.scratch/operacao-do-lead/spec.md) ("não quero alcançar lead cujo dono atual está fora do meu time") não pega, porque tecnicamente o dono atual **está** no time.

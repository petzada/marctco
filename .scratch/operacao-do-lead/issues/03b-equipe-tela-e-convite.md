...
- [x] Tela Equipe na barra, só para quem a matriz alcança na leitura; **a rota recusa Atendente sozinha** ([ADR-0015](../../../docs/adr/0015-perfis-de-acesso-e-escopo.md)). Ausência de item não é o controle de acesso — aqui há dado que o Atendente não pode ler, e por isso é recusa de verdade
- [x] Cadastro é da **Direção**. Papel oferecido no formulário: só Atendente, Supervisor e Gestão — nunca Direção ([ADR-0021](../../../docs/adr/0021-dois-caminhos-de-nascimento-login-fechado.md))
...
- [x] Criar tag que ainda não existe e aplicá-la ao membro são o mesmo gesto na tela; várias tags no mesmo membro; **sem tela de taxonomia em Configurações** ([ADR-0020](../../../docs/adr/0020-tag-no-membro-define-o-time.md))

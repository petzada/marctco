...
- [x] `SUPERVISOR` **deixa de ser tratado como `MANAGER`** em toda leitura e escrita que hoje herda Gestão (lista, contadores, card, edição, resolver identidade/duplicidade). A equivalência temporária do [ADR-0015](../../../docs/adr/0015-perfis-de-acesso-e-escopo.md) termina neste ticket

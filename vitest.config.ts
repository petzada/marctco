      ...
      },
      {
        ...
        test: {
          ...
          include: [
            ...
            "packages/db/tests/{boot-check,feature-flags,intake,intake-review-resolution,integration-connection-operations,lead-board,leads,outbox-recovery,person-candidates,quarantine,rls,team,team-membership-lifecycle,workspace-settings}.test.ts"
          ],

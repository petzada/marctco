      ...
      },
      {
        ...
        test: {
          ...
          include: [
            ...
            "packages/db/tests/{activities,boot-check,feature-flags,first-contact,intake,intake-review-resolution,integration-connection-operations,lead-board,leads,outbox-recovery,person-candidates,quarantine,rls,team,team-membership-lifecycle,workspace-settings}.test.ts"
          ],

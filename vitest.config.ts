      ...
      },
      {
        ...
        test: {
          ...
          include: [
            ...
            "packages/db/tests/{boot-check,feature-flags,intake,intake-review-resolution,integration-connection-operations,leads,outbox-recovery,person-candidates,quarantine,rls,team}.test.ts"
          ],
